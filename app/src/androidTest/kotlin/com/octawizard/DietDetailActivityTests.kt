...
import com.octawizard.matchers.ToolbarMatcher.onToolbarWithTitle
...
class DietDetailActivityTests :
    AcceptanceTest<DietDetailActivity>(DietDetailActivity::class.java) {
    ...
    private fun startActivity(superHero: SuperHero): DietDetailActivity {
        val args = Bundle()
